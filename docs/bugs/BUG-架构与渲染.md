...
- **来源**：`docs/history/AI交接指导-合集.md` §五 5.1
...
- **来源**：`docs/history/测试日志-2026-09-12.md` BUG-1
...
- **来源**：`docs/history/测试日志-2026-09-12.md` BUG-8
...
- **来源**：测试日志-2026-09-13 BUG-5；大库压测记录 §10.4
...
- **来源**：测试日志-2026-09-13 BUG-6；大库压测记录 §十
...
- **来源**：测试日志-2026-09-13 BUG-9；大库压测记录 §11.3
