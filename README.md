...
[⬇️ 下载安装包 `sillytavern-card-manager-2.2.12.exe`](https://github.com/tian2418671-sys/JSKZX/releases/latest)

**📦 绿色免安装版**（解压即用，无需安装）：

[⬇️ 下载绿色版 `sillytavern-card-manager-2.2.12.zip`](https://github.com/tian2418671-sys/JSKZX/releases/latest)
...
├── test/                   # node:test 单元测试（290 用例 / 27 个文件）
