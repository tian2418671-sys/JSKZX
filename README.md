...
[⬇️ 下载安装包 `sillytavern-card-manager-2.2.14.exe`](https://github.com/tian2418671-sys/JSKZX/releases/latest)

**📦 绿色免安装版**（解压即用，无需安装）：

[⬇️ 下载绿色版 `sillytavern-card-manager-2.2.14.zip`](https://github.com/tian2418671-sys/JSKZX/releases/latest)
...
### 📌 近期版本要点（v2.2.x）
- **v2.2.14** —— 修复：自动分组弹窗在**未配置 / 未保存收纳规则**时点「🔄 重新扫描」无任何反应（容易误以为按钮坏了）——现在点击即就地提示「先添加规则并保存」；「预览与执行」页空态文案同步改进
...
- `dist/sillytavern-card-manager-2.2.14.exe` —— NSIS 安装包
