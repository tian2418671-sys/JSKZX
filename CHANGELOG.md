...
## � 未发布 · 查重引擎 v4 全量落地（P0~P2，2026-09-25）
...
## �🔻 未发布 · 查重旧实现**整体下线**（推倒重来，2026-09-25）
...
## 🩹 未发布 · 内容查重「误报四形态」根治 + 提醒按百分比分档（2026-09-25）
...
## 🩹 未发布 · 记忆库逐条编辑 + 查重综合分排序 + 世界书规格状态同步（2026-09-24）
...
## 🩹 未发布 · AI 打标「提示词分角色 + 结构化输出」（2026-09-24）
...
## 🩹 未发布 · 世界书保存格式修复 + 分组与标签（2026-09-24）
...
> ｜ 后续升级（**搜置**）：[`AI打标-提示词分角色与结构化输出方案.md`](docs/规格与计划/AI打标/AI打标-提示词分角色与结构化输出方案.md)
