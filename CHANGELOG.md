...
> 依据：[`docs/规格与计划/AI打标-提示词分角色与结构化输出方案.md`](docs/规格与计划/AI打标-提示词分角色与结构化输出方案.md)（R1 + R2，状态已改「✅ 已落地」）
...
> 依据：[`docs/规格与计划/角色卡与预设查重-方案评估.md`](docs/规格与计划/角色卡与预设查重-方案评估.md) §三 P0
...
> 规格：[`docs/规格与计划/世界书库分组与标签-实现规格.md`](docs/规格与计划/世界书库分组与标签-实现规格.md)（`RFC-20260921-WB-TAGS-02`）
