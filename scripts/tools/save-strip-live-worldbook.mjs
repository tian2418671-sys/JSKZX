 ...
 * 用法：node scripts/tools/save-strip-live-worldbook.mjs <userData 下的可写样本目录>
 */
import { join } from 'node:path';

const CDP_HTTP = 'http://127.0.0.1:9222/json/list';
const DIR = process.argv[2];
if (!DIR) { console.error('用法: node scripts/tools/save-strip-live-worldbook.mjs <样本目录>'); process.exit(1); }
