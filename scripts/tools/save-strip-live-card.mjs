 ...
 * 用法：node scripts/tools/save-strip-live-card.mjs <userData/_strip_verify 目录>
 */
import { join } from 'node:path';

const CDP_HTTP = 'http://127.0.0.1:9222/json/list';
const SAMPLE_DIR = process.argv[2];
if (!SAMPLE_DIR) { console.error('用法: node scripts/tools/save-strip-live-card.mjs <样本目录>'); process.exit(1); }
