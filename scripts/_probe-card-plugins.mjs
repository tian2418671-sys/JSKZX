 ...
 *
 * 用法：
 *   node scripts/_probe-card-plugins.mjs "E:\AI\酒馆工具\角色卡"            # 形态统计（默认）
 *   node scripts/_probe-card-plugins.mjs "E:\AI\酒馆工具\角色卡" --perf     # 另加解析开销（含最重卡）
 *   node scripts/_probe-card-plugins.mjs "<库根>" 500                      # 只扫前 500 张（大库抽样）
 *
 * 形态统计输出：
