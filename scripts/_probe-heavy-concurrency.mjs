 ...
 *
 * 用法：node --expose-gc scripts/_probe-heavy-concurrency.mjs "H:\01\全局世界书" [并发档位...]
 *   例：node --expose-gc scripts/_probe-heavy-concurrency.mjs "H:\01\全局世界书" 1 3 6 12
 *
...
if (!DIR) { console.error('用法：node --expose-gc scripts/_probe-heavy-concurrency.mjs <目录> [并发档位...]'); process.exit(1); }
