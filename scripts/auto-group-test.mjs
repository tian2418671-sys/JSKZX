 ...
 *   ① node scripts/auto-group-test.mjs --prep      # 建隔离库（含中文分组文件夹）+ 写隔离 profile 配置
 *   ② 起实例：
 ...
 *   ③ node scripts/auto-group-test.mjs             # 本脚本自等实例就绪后驱动验收
 *   ④ node scripts/auto-group-test.mjs --cleanup   # 删隔离库/profile
 *
